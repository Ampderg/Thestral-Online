...
public class FlexibleColorPicker : MonoBehaviour, IGetColor {
    ...
    */
    ...
    internal CharacterAppearanceMenu appearanceMenu;
    internal string colorTag;
    ...
    */
    ...
    private void UpdateTextures() {
        ...
        if (appearanceMenu != null) appearanceMenu.UpdateColorTag(colorTag);
    }
